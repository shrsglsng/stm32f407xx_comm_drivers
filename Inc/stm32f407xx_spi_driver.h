...
#define SPI_FALG_RXNE 0
#define SPI_FALG_TXE 1
#define SPI_FALG_CHSIDE 2
#define SPI_FALG_UDR 3
#define SPI_FALG_CRCERR 4
#define SPI_FALG_MODF 5
#define SPI_FALG_OVR 6
#define SPI_FALG_BSY 7
#define SPI_FALG_FRE 8
